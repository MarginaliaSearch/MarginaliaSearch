...
public class EdgeSearchFlagSiteService {
    ...
    @Inject
    public EdgeSearchFlagSiteService(RendererFactory rendererFactory,
                                     HikariDataSource dataSource) throws IOException {
        formTemplate = rendererFactory.renderer("edge/indict/indict-form");
