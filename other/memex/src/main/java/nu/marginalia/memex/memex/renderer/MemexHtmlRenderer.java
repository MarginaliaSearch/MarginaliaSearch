...
public class MemexHtmlRenderer {
    ...
    public MemexHtmlRenderer(
        ...
        viewRenderer = rendererFactory.renderer("static/memex/memex-view");
        indexRenderer = rendererFactory.renderer("static/memex/memex-index");
        indexFeedRenderer = rendererFactory.renderer("static/memex/memex-index-feed");
        imageRenderer = rendererFactory.renderer("static/memex/memex-image");

        tombstoneRenderer = rendererFactory.renderer("static/memex/memex-tombstone");

        updateFormRenderer = rendererFactory.renderer("static/memex/memex-update-form");
        uploadFormRenderer = rendererFactory.renderer("static/memex/memex-upload-form");
        deleteFormRenderer = rendererFactory.renderer("static/memex/memex-delete-form");
        renameFormRenderer = rendererFactory.renderer("static/memex/memex-rename-form");
        createFormRenderer = rendererFactory.renderer("static/memex/memex-create-form");
