...
public class JsonReader implements Closeable {
    ...
    static {
        // It would be very unfortunate if one of the services would be using this
        // version of JsonReader.  Logging a warning message to ensure that we know
        // if this is happening.

        System.err.println(
            """
            Using monkey patched JsonReader implementation.
            
            This is only for use in converter and other scenarios where
            a fixed number of threads are parsing JSON.
            
            Remove the 'monkey-patch-gson' dependency to get rid of this warning.
            """);
    }
     ...
     *     malformed.
     */
    static ThreadLocal<StringBuilder> bigBuilder = ThreadLocal.withInitial(StringBuilder::new);
    private String nextQuotedValue(char quote) throws IOException {
        // Like nextNonWhitespace, this uses locals 'p' and 'l' to save inner-loop field access.
        char[] buffer = this.buffer;
        StringBuilder builder = bigBuilder.get();
        builder.setLength(0);
