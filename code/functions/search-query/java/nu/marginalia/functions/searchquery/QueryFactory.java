...
public class QueryFactory {
    ...
    public ProcessedQuery createQuery(RpcQsQuerySimple request,
        ...
        specs.query.searchTermsAdvice.addAll(searchFilter.termsRequire());
        specs.query.searchTermsPriority.addAll(searchFilter.termsPromote());
        specs.query.searchTermsPriorityWeight.addAll(searchFilter.termsPromoteAmounts());
        specs.query.searchTermsExclude.addAll(searchFilter.termsExclude());

        return new ProcessedQuery(specs, searchTermsHuman, domain, request.getLangIsoCode());
    }
