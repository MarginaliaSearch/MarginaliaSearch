...
CREATE TABLE IF NOT EXISTS DOMAIN_PING_STATUS (
...
CREATE INDEX IF NOT EXISTS DOMAIN_PING_STATUS__NODE_ID__DOMAIN_ID_IDX ON DOMAIN_PING_STATUS (NODE_ID, DOMAIN_ID);
CREATE INDEX IF NOT EXISTS DOMAIN_PING_STATUS__NEXT_SCHEDULED_UPDATE_IDX ON DOMAIN_PING_STATUS (NODE_ID, NEXT_SCHEDULED_UPDATE);
