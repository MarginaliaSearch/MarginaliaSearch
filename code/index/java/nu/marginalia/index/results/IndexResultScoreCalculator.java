...
public class IndexResultScoreCalculator {
                                           ...
                                           CodedSequence[] positions)
    {
        ...
        CompiledQueryInt positionsCountQuery = positionsQuery.mapToInt(pos -> pos == null ? 0 : pos.valueCount());
        ...
        int minPositionsCount = intMaxMinAggregate(positionsCountQuery, p -> p);
